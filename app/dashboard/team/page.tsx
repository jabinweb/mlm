...
export default function TeamPage() {
  ...
  const shareViaWhatsApp = () => {
    const message = `Hey! Join MLM Pro using my referral link and start earning: ${getReferralLink()}`
    window.open(`https://wa.me/?text=${encodeURIComponent(message)}`, '_blank')
  }

  const shareViaEmail = () => {
    const subject = 'Join MLM Pro and Start Earning!'
    const body = `Hi there!\n\nI'd like to invite you to join MLM Pro, an amazing platform where you can earn money through our referral system.\n\nClick here to join: ${getReferralLink()}\n\nBest regards!`
